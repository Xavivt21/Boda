$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Casament Inés i Josep!",

            // Event start date
            start: new Date('Sep 4, 2021 13:30'),
            ...
            end: new Date('Sep 5, 2021 00:00'),

            // Event Address
            address: 'Carrer Rosselló, 175, Barcelona',

            // Event Description
            description: "Us esperem amb moltíssima il·lusió!"
        }
    });
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        /*if (MD5($('#invite_code').val()) !== 'b0e53b10c1f55ede516b240036b88f40'
            ...
            $.post('https://script.google.com/macros/s/AKfycbwk6IUkbNip6cof_evVRSl5-zsjQOh_vkHKlfkBK7nwQwe5j2melVvxO-tVGaXE5RNRRw/exec', data)
                .done(function (data) {
                    console.log(data);
